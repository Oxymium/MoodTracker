...
public class MainActivity extends AppCompatActivity {
    ...
    private int mFirstDayLaunch; /* Saves day_of_year on first app launch */
    private int mCurrentDay; /* Gets date of the current day (int value) */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mYesterday = mCurrentDay - 1;
        m2DaysAgo = mCurrentDay - 2;
        m3DaysAgo = mCurrentDay - 3;
        m4DaysAgo = mCurrentDay - 4;
        m5DaysAgo = mCurrentDay - 5;
        m6DaysAgo = mCurrentDay - 6;
        m7DaysAgo = mCurrentDay - 7;




        /* Adds first day only if it doesn't exist (initialize variables) */
        // if (mFirstDayLaunch == 0) {
           // mFirstDayLaunch = mCurrentDay;
        //}
        ...
        mHistoryButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                historyActivity.putExtra("CurrentDayTest", mCurrentDay);
